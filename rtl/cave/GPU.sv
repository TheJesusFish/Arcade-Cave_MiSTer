...
module GPU(
  ...
  input  [2:0]   io_layerCtrl_0_format,
  ...
  input  [2:0]   io_layerCtrl_1_format,
  ...
  input  [2:0]   io_layerCtrl_2_format,
  input          io_layerCtrl_2_tileBank,
  ...
  input  [2:0]   io_spriteCtrl_format,
  ...
  CaveLayerProcessor #(
    ...
    .io_spriteOffset_x            (io_spriteCtrl_regs_offset_x),
    .io_spriteOffset_y            (io_spriteCtrl_regs_offset_y),
    .io_ctrl_tileBank             (io_layerCtrl_2_tileBank),
  ...
  ColorMixer colorMixer (
    ...
    .io_gameConfig_layer_0_granularity (io_gameConfig_layer_0_granularity),
    .io_gameConfig_layer_1_format      (io_layerCtrl_1_format),
    .io_gameConfig_layer_1_paletteBank (io_gameConfig_layer_1_paletteBank),
    .io_gameConfig_layer_1_granularity (io_gameConfig_layer_1_granularity),
    .io_gameConfig_layer_2_format      (io_layerCtrl_2_format),
    .io_gameConfig_layer_2_paletteBank (io_gameConfig_layer_2_paletteBank),
    .io_gameConfig_layer_2_granularity (io_gameConfig_layer_2_granularity),
    .io_gameConfig_sprite_granularity  (io_gameConfig_sprite_granularity),
