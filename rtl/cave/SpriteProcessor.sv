...
module SpriteProcessor(
  ...
  always @(posedge clock) begin
    ...
    if (stateReg == STATE_LATCH) begin
      ...
      spriteReg_cols <= io_ctrl_zoom ? io_ctrl_vram_dout[111:104] : io_ctrl_vram_dout[79:72];
      spriteReg_rows <= io_ctrl_zoom ? io_ctrl_vram_dout[103:96] : io_ctrl_vram_dout[71:64];
