...
module Main(
  ...
  reg         videoVBlankRisingDelay;
  wire        videoVBlankRising = videoVBlankPipe1 & ~videoVBlankRisingDelay;
  reg         pauseInputDelay;
  reg         pauseActive;
  reg         videoIrq;
  reg         agalletIrq;
  ...
  wire        gameIsGuwange = io_gameIndex == GAME_GUWANGE;
  ...
  wire        gameIsDonPachi = io_gameIndex == GAME_DONPACHI;
  ...
  wire        gameIsDoDonPachi = io_gameIndex == GAME_DDONPACH;
  ...
  wire        gameIsEsprade = io_gameIndex == GAME_ESPRADE;
  ...
  wire        gameIsUopoko = io_gameIndex == GAME_UOPOKO;
  wire        cs_214 = cpuByteAddr < 24'h100000;
  wire        cs_215 = (|(_cpu_io_addr[22:19])) & cpuByteAddr < 24'h110000;
  wire        mainRam_io_rd = gameIsUopoko ? cs_215 & readStrobe : _GEN_190;
  wire        mainRam_io_wr = gameIsUopoko ? cs_215 & writeStrobe : _GEN_191;
  wire        cs_216 = cpuByteAddr > 24'h2FFFFF & cpuByteAddr < 24'h300004;
  wire        cs_217 = (|(_cpu_io_addr[22:21])) & cpuByteAddr < 24'h410000;
  wire        spriteRam_io_portA_rd = gameIsUopoko ? cs_217 & readStrobe : _GEN_206;
  wire        spriteRam_io_portA_wr = gameIsUopoko ? cs_217 & writeStrobe : _GEN_207;
  ...
  wire        vram8x8_0_io_portA_rd = gameIsUopoko ? cs_221 & readStrobe : _GEN_199;
  wire        vram8x8_0_io_portA_wr = gameIsUopoko ? cs_221 & writeStrobe : _GEN_200;
  reg  [15:0] tmp_37;
  wire        cs_224 = cpuByteAddr > 24'h5FFFFF & cpuByteAddr < 24'h600010;
  wire        spriteRegs_io_mem_wr = gameIsUopoko ? mem_7_wr : _GEN_201;
  ...
  wire        layerRegs_0_io_mem_wr = gameIsUopoko ? cs_227 & writeStrobe : _GEN_205;
  wire        cs_228 = _cpu_io_addr[22] & cpuByteAddr < 24'h810000;
  wire        paletteRam_io_portA_rd = gameIsUopoko ? cs_228 & readStrobe : _GEN_192;
  wire        paletteRam_io_portA_wr = gameIsUopoko ? cs_228 & writeStrobe : _GEN_193;
  wire [14:0] paletteRam_io_portA_addr = gameIsUopoko ? _cpu_io_addr[14:0] : _GEN_194;
  ...
  wire [15:0] input0 =
    gameIsGuwange
      ...
      : {_GEN_211,
         ...
         ~io_player_0_down,
         ~io_player_0_up};
  wire [15:0] _GEN_212 = gameIsGuwange ? _left_T_27 : default1;
  wire [15:0] _GEN_213 = gameIsGuwange ? _left_T_27 : _left_T_12;
  ...
  wire [15:0] _GEN_214 =
    {10'h3F,
     ...
     ~coin2_s_enableReg,
     ~coin1_s_enableReg};
  wire [15:0] _right_T_11 = gameIsGaia ? _GEN_214 : default2;
  wire [15:0] input1 = gameIsGuwange ? _right_T_9 : _right_T_11;
  wire [15:0] _GEN_215 = gameIsGuwange ? _right_T_9 : default2;
  wire [12:0] _GEN_216 =
    gameIsGuwange
  ...
  wire        eepromMem_wr = gameIsUopoko ? cs_231 & writeStrobe : _GEN_430;
  ...
  always @(posedge clock) begin
    videoVBlankPipe0 <= io_video_vBlank;
    videoVBlankPipe1 <= videoVBlankPipe0;
    videoVBlankRisingDelay <= videoVBlankPipe1;
    pauseInputDelay <= pausePressed;
    readStrobe_REG <= _cpu_io_as;
    upperWriteStrobe_REG <= _cpu_io_uds;
    lowerWriteStrobe_REG <= _cpu_io_lds;
    videoVBlankPrevious <= videoVBlankPipe1;
    ...
    if (reset) begin
      ...
      pauseActive <= pausePressed & ~pauseInputDelay ^ pauseActive;
      videoIrq <=
        _GEN_421 ? ~(_offset_T_222 == 24'h4 | _GEN_412) & _GEN_385 : ~_GEN_412 & _GEN_385;
      agalletIrq <= videoVBlankRising | ~(~videoVBlankPipe1 & videoVBlankPrevious) & agalletIrq;
      unknownIrq <=
        _GEN_421 ? ~(_offset_T_222 == 24'h6 | _GEN_413) & _GEN_386 : ~_GEN_413 & _GEN_386;
      if (gameIsUopoko) begin
        if (_GEN_423)
          dinReg <= input1;
        else if (_GEN_422)
          dinReg <= input0;
      ...
      if (eepromMem_wr) begin
        eeprom_io_serial_cs_r <= gameIsGuwange ? _cpu_io_dout[5] : _cpu_io_dout[9];
        eeprom_io_serial_sck_r <= gameIsGuwange ? _cpu_io_dout[6] : _cpu_io_dout[10];
        eeprom_io_serial_sdi_r <= gameIsGuwange ? _cpu_io_dout[7] : _cpu_io_dout[11];
      end
  ...
  assign io_soundCtrl_req = gameIsHotdogStorm & _GEN_204;
  assign io_soundCtrl_data = _cpu_io_dout;
  assign io_progRom_rd = gameIsUopoko ? cs_214 & readStrobe : _GEN_189;
